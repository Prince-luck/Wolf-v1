...
global.github = process.env.GITHUB || "https://github.com/Prince-luck/Wolf-v1";
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.imgur.com/Xiqru2L.jpeg";
...
module.exports = {
  ...
  LANG: (process.env.THEME || "W O L F").toUpperCase(),
};
global.rank = "updated";
